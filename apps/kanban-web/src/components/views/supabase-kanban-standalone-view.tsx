...
import { KanbanBoard } from '../session-manager/kanban-board';
import { isSupabaseConfigured } from '@ui/lib/supabase';
import { useSupabaseAuthStore } from '@ui/store/supabase-auth-store';
import { useSupabaseProjects } from '@ui/hooks/use-supabase-projects';
import { useSupabaseTasks } from '@ui/hooks/use-supabase-tasks';

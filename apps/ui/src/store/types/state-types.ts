...
export interface AppActions {
  ...
  setProjectBadgeColor: (projectId: string, badgeColor: string | null) => void;
  setProjectBackgroundColor: (projectId: string, backgroundColor: string | null) => void;

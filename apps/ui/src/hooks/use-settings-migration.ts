...
export function parseLocalStorageSettings(): Partial<GlobalSettings> | null {
  try {
    ...
    return {
      ...
      notificationSoundVolume: state.notificationSoundVolume as number,
      notificationSoundFile: state.notificationSoundFile as string,
      allPhasesCompleteSoundFile: state.allPhasesCompleteSoundFile as string,
...
export function hydrateStoreFromSettings(settings: GlobalSettings): void {
  ...
  useAppStore.setState({
    ...
    notificationSoundVolume: settings.notificationSoundVolume ?? 0.5,
    notificationSoundFile: settings.notificationSoundFile ?? 'notification.mp3',
    allPhasesCompleteSoundFile: settings.allPhasesCompleteSoundFile ?? 'notification.mp3',
...
function buildSettingsUpdateFromStore(): Record<string, unknown> {
  ...
  return {
    ...
    notificationSoundFile: state.notificationSoundFile,
    allPhasesCompleteSoundFile: state.allPhasesCompleteSoundFile,

...
export async function refreshSettingsFromServer(): Promise<boolean> {
  try {
    ...
    useAppStore.setState({
      ...
      notificationSoundVolume: serverSettings.notificationSoundVolume ?? 0.5,
      notificationSoundFile: serverSettings.notificationSoundFile ?? 'notification.mp3',
      allPhasesCompleteSoundFile: serverSettings.allPhasesCompleteSoundFile ?? 'notification.mp3',
